...
void Game::Render()
{
    ...
    {
        // draw background
        Texture2D text_background = ResourceManager::GetTexture("background");
        Renderer->DrawSprite(text_background, glm::vec2(0.0f, 0.0f), glm::vec2(this->Width, this->Height), 0.0f);
        // draw level
